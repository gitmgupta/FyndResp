...

{
	...
	// 3.Post Method
	public CloseableHttpResponse post(String url, String body, HashMap<String, String> header)
			throws ClientProtocolException, IOException {
		// Created HttpCLient for connection
		httpClientConnection = HttpClients.createDefault();
	...
	public CloseableHttpResponse delete(String url, HashMap<String, String> header)
			throws ClientProtocolException, IOException {
		httpClientConnection = HttpClients.createDefault();
		HttpDelete deleteRequest = new HttpDelete(url);
		for (Map.Entry<String, String> entry : header.entrySet()) {
	...
	public CloseableHttpResponse put(String url, String body, HashMap<String, String> header)
			throws ClientProtocolException, IOException {
		httpClientConnection = HttpClients.createDefault();
